...
module GlobalMilesPos
  ...
  class PayWithMilesController < BaseController
    ...
    def create_complete_mile_payment(body)
      # Prepare query url.
      _query_builder = Configuration.get_base_uri
    ...
    def create_cancel_mile_payment(body)
      # Prepare query url.
      _query_builder = Configuration.get_base_uri
    ...
    # and OAuthClientSecret is
    # d0a8b00a3d754ea5a013465bcc23f6efa89e9dfb080a4f4eb460e3306653d92b
    # @param [GetMileProvisionsRequest] body Required parameter: The body of the
    # request.
    # @return GetBonusProvisionsResponse response from the API call
    def create_get_mile_provisions(body)
      # Prepare query url.
      _query_builder = Configuration.get_base_uri
